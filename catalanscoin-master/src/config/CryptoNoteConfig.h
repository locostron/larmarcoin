...
/* The mixin to use by default with zedwallet and guayacanes-service */
...
const char     LATEST_VERSION_URL[]                          = "http://latest.guayacanescoin.com";
const std::string LICENSE_URL                                = "https://github.com/guayacanescoin/guayacanescoin/blob/master/LICENSE";
